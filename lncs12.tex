...
Thus, the outliers represented as points make less difference to the average speed. we can see for DAAT\_AND, the median almost stays the same, however, OptPFOR ranks the first of the average time due to its smaller outliers.
...
% 尽管不如optimal，但在提供了一个折中的方案，在追求快速压缩的情况下可以使用
% 由于optimal partitioning仅关注压缩，其查询速度并不理想，可以以后bicriteria
