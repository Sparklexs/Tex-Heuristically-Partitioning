...
% how we build query set
% the differences of boolean query and dynamic pruning
% measuring in  microseconds
% our goal is only to prove our methods are not obviously inferior to the orignal one.
...
%Experiments show its construction time is far shorter than the originals while keeping competitive index size and query efficiency.
