...
\begin{table}
	...
	\begin{tabular}{@{}ll*{4}{r}}
		\toprule
		\multirow{2}*{collection} & \multirow{2}*{method} & \multicolumn{1}{c}{compress} & \multicolumn{1}{c}{docid} & \multicolumn{1}{c}{freq} & \multicolumn{1}{c}{decompress} \\
		...
		\midrule
		\multirow{5}*{Common Crawl} & discreet & 1926.84 & 7.54 & 3.03 & 178.64 \\
...
%\textit{Optimal} has larger partition lengths but smaller index size than \textit{coarse} and \textit{discreet}, proving the fact it can better exploit the local clustering of the posting list.
